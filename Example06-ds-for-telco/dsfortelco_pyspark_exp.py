...
model.write().overwrite().save("models/telco")
...
!rm -r -f models/telco
!rm -r -f models/telco_rf.tar
!hdfs dfs -get models/telco models/
!tar -cvf models/telco_rf.tar models/telco


cdsw.track_file("models/telco_rf.tar")
